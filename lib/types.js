...
function mat2 (v0, v1) {
	...
	return this.createTypeResult(`[${[v0, v1].map(this.stringify, this).join(', ')}]`, [v0, v1]);
}

function mat3 (v0, v1, v2) {
	return this.createTypeResult(`[${[x0, y0, z0, x1, y1, z1].map(this.stringify, this).join(', ')}]`, [x0, y0, z0, x1, y1, z1]);
}

function mat4 (v0, v1, v2, v3) {
	return this.createTypeResult(`[${[x0, y0, z0, w0, x1, y1, z1, w1].map(this.stringify, this).join(', ')}]`, [x0, y0, z0, w0, x1, y1, z1, w1]);
}
