...
function mat4 (v0, v1, v2, v3) {
	...
	//mat4(mat3)
	if (v0type === 'mat3') {
		this.createTypeResult(
			`[${this.types.vec4.call(this, v0, 0)}, ${this.types.vec4.call(this, 0, v0, 0, 0)}, ${this.types.vec4.call(this, 0, 0, v0, 0)}, ${this.types.vec4.call(this, 0, 0, 0, v0)}]`,
			[
