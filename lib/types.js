...
// array creator (either `[<inits>]` or `new Float32Array(<inits>)`)
// var arr = (inits) => `new Float32Array(${inits})`
var arr = (inits) => `[${inits}]`
...
function createVec3(type, vecType) {
	...
	function vec3(x, y, z) {
		...
		if (this.types[x.type].length === 2) {
			return Descriptor(`[...${x}, ${this.types.float.call(this, y)}]${map}`, {
		...
		if (this.types[y.type].length > 1) {
			return Descriptor(`[${x}, ...${this.types.vec2.call(this, y, z)}]${map}`, {
		...
		return Descriptor(`${arr([x, y, z].join(', '))}${map}`, {
...
function createVec4(type, vecType) {
	...
	function vec4(x, y, z, w) {
		...
		if (this.types[x.type].length === 2) {
			//vec4(vec2, vecN)
			if (this.types[y.type].length > 1) {
				return Descriptor(`[...${x}, ${this.types.vec2.call(this, y)}]${map}`, {
			...
			var res = Descriptor(
				`[...${x}, ...${this.types.vec2.call(this, y, z)}]${map}`, {
		...
		if (this.types[y.type].length === 2) {
			return Descriptor(`[${x},...${this.types.vec2.call(this, y)}, ${this.types.float.call(this, z)}]${map}`, {
		...
		//vec4(float, vecN)
		if (this.types[y.type].length > 2) {
			return Descriptor(`[${x},...${this.types.vec3.call(this, y, z, w)}]${map}`, {
		...
		if (this.types[z.type].length > 1) {
			return Descriptor(`[${x},${y}, ...${this.types.vec2.call(this, z)}]${map}`, {
...
function mat2(v0, v1) {
	...
	return Descriptor(`[...${this.types.vec2.call(this, v0)},...${this.types.vec2.call(this, v1)}]`, {
...
function mat3(v0, v1, v2) {
	...
	var res = Descriptor(`[...${this.types.vec3.call(this, v0)},...${this.types.vec3.call(this, v1)}, ...${this.types.vec3.call(this, v2)}]`, {
		components: comps.map(float, this),
		type: 'mat3',
		complexity: cmpl(comps)
	});
...
function mat4(v0, v1, v2, v3) {
	...
	return Descriptor(`[...${this.types.vec4.call(this, v0)}, ...${this.types.vec4.call(this, v1)}, ...${this.types.vec4.call(this, v2)}, ...${this.types.vec4.call(this, v3)}]`, {
		components: comps.map(float, this),
		type: 'mat4',
		complexity: cmpl(comps)
	});
