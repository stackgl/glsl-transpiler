...
vec.prototype.mult = function (arg) {
...
vec.prototype.type = float;
vec.prototype.dimensions = 4;
vec.prototype.vec2 = vec2;
vec.prototype.vec3 = vec3;
vec.prototype.vec4 = vec4;
...
function swizzle (target) {
	...
	function createSwizzle (target, i,j,k,l, abbr) {
		...
		var len = prop.length;
		var vec = target.constructor['vec' + len] || target.constructor.type;
