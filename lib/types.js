...
function mat3 (v0, v1, v2) {
	...
	//mat3(mat2)
	if (v0Type === 'mat2') {
		return this.createTypeResult(`[0,1,null, 2,3,null, null,null,-1].map(function (i) {return i == null ? 0 : i < 0 ? -i : this[i]}, ${this.stringify(v0)})`,
			[
...
function mat4 (v0, v1, v2, v3) {
	...
	if (v0Type === 'mat2') {
		return this.createTypeResult(
			`[0,1,null,null, 2,3,null,null, null,null,-1,null, null,null,null,-1].map(function (i) {return i == null ? 0 : i < 0 ? -i : this[i]}, ${this.stringify(v0)})`,
			[
	...
	if (v0Type === 'mat3') {
		var components = this.getComponents(v0);
		return this.createTypeResult(
			`[0,1,2,null,3,4,5,null,6,7,8,null,null,null,null,-1].map(function (i) {return i == null ? 0 : i < 0 ? -i : this[i]}, ${this.stringify(v0)})`,
