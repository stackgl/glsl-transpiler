...
/**
 * Types operations.
 * Mostly copy-paste from gl-matrix to ensure stringify-ability
 */
...
vec2.mod = function(out, a, b) {
	out[0] = a[0] % b[0];
	out[1] = a[1] % b[1];
	return out;
};
vec2.lshift = function(out, a, b) {
	out[0] = a[0] << b[0];
	out[1] = a[1] << b[1];
	return out;
};
vec2.rshift = function(out, a, b) {
	out[0] = a[0] >> b[0];
	out[1] = a[1] >> b[1];
	return out;
};
vec2.and = function(out, a, b) {
	out[0] = a[0] & b[0];
	out[1] = a[1] & b[1];
	return out;
};
vec2.or = function(out, a, b) {
	out[0] = a[0] | b[0];
	out[1] = a[1] | b[1];
	return out;
};
vec2.xor = function(out, a, b) {
	out[0] = a[0] ^ b[0];
	out[1] = a[1] ^ b[1];
	return out;
};
...
vec3.mod = function(out, a, b) {
	out[0] = a[0] % b[0];
	out[1] = a[1] % b[1];
	out[2] = a[2] % b[2];
	return out;
};
vec3.lshift = function(out, a, b) {
	out[0] = a[0] << b[0];
	out[1] = a[1] << b[1];
	out[2] = a[2] << b[2];
	return out;
};
vec3.rshift = function(out, a, b) {
	out[0] = a[0] >> b[0];
	out[1] = a[1] >> b[1];
	out[2] = a[2] >> b[2];
	return out;
};
vec3.and = function(out, a, b) {
	out[0] = a[0] & b[0];
	out[1] = a[1] & b[1];
	out[2] = a[2] & b[2];
	return out;
};
vec3.or = function(out, a, b) {
	out[0] = a[0] | b[0];
	out[1] = a[1] | b[1];
	out[2] = a[2] | b[2];
	return out;
};
vec3.xor = function(out, a, b) {
	out[0] = a[0] ^ b[0];
	out[1] = a[1] ^ b[1];
	out[2] = a[2] ^ b[2];
	return out;
...
//FIXME: these guys may return wrong type in getType, in case if first arg is float
