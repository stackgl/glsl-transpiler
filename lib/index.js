...
/**
 * Max number of operations allowable to repeat in unfolding arrays.
 ...
 *
 * e.g. `vec(fn(x)) → [fn(x), fn(x)]`, if complexity of fn(x) < 10.
 * and `vec(fn(x)) → [0, 0].fill(fn(x))`, if complexity of fn(x) > 10
 */
